"""
Django settings for with_you_system project.
...
SECRET_KEY = "django-insecure-2sa=$d7gktazo5uw83rps66(29@^)cg-bo(q-2b!szs(gcy53x"
...
MIDDLEWARE = [
    ...
    'md.middleware.AuthenticationMiddleware'
]
...
WSGI_APPLICATION = "with_you_system.wsgi.application"
